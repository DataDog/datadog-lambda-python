...
#### 2. Subscribe the Datadog Forwarder to the Log Groups
...
#### 3. Subscribe the Datadog Forwarder to the Log Groups
...
If you find an issue with the Datadog Lambda Library package and have a fix, please feel free to open a pull request following the [procedures](CONTRIBUTING.md).
