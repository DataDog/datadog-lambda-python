...
_test_create_inferred_span = (
    ...
    ("api-gateway-non-proxy-async", _Span(
    ...
    ("api-gateway-websocket-default", _Span(
    ...
    ("api-gateway-websocket-connect", _Span(
        service="p62c47itsb.execute-api.eu-west-1.amazonaws.com",
    ...
    ("api-gateway-websocket-disconnect", _Span(
        service="p62c47itsb.execute-api.eu-west-1.amazonaws.com",
    ...
    ("sqs-string-msg-attribute", _Span(
        service="sqs",
    ...
    ("sns-string-msg-attribute", _Span(
        service="sns",
    ...
    ("authorizer-request-api-gateway-v1", _Span(
    ...
    ("authorizer-request-api-gateway-v1-cached", _Span(
        service="amddr1rix9.execute-api.eu-west-1.amazonaws.com",
    ...
    ("authorizer-token-api-gateway-v1", _Span(
        service="amddr1rix9.execute-api.eu-west-1.amazonaws.com",
        start=1663295021.832,
        span_type="http",
        parent_name="aws.apigateway.authorizer",
    ...
    ("authorizer-token-api-gateway-v1-cached", _Span(
        service="amddr1rix9.execute-api.eu-west-1.amazonaws.com",
        start=1666803622.99,
        span_type="http",
        tags={
    ...
    ("authorizer-request-api-gateway-v2", _Span(
        service="amddr1rix9.execute-api.eu-west-1.amazonaws.com",
    ...
    ("authorizer-request-api-gateway-v2-cached", _Span(
        service="amddr1rix9.execute-api.eu-west-1.amazonaws.com",
    ...
    ("authorizer-request-api-gateway-websocket-connect", _Span(
        service="amddr1rix9.execute-api.eu-west-1.amazonaws.com",
    ...
    ("authorizer-request-api-gateway-websocket-message", _Span(
        service="amddr1rix9.execute-api.eu-west-1.amazonaws.com",
